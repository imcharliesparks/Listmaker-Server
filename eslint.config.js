...
exports.default = (0, config_1.defineConfig)(js_1.default.configs.recommended, eslint_plugin_n_1.default.configs['flat/recommended-script'], ...typescript_eslint_1.default.configs.strictTypeChecked, ...typescript_eslint_1.default.configs.stylisticTypeChecked, {
    ignores: [
        '**/node_modules/*',
        '**/*.mjs',
        '**/*.js',
